    ...
    public Room CreateRoom(RoomDTO roomDTO, IGameStorage storage)
    {
        ...
        switch (data.RoomType)
        {
            case { } type when type == typeof(AnyFormRoom):
                return new AnyFormRoom(roomDTO.Id, data.Name, new MapIndex(roomDTO.MapOffsetY, roomDTO.MapOffsetX), 
                    roomDTO.Floor, roomDTO.Color, roomDTO.Rotation, roomDTO.State,
            ...
            case { } type when type == typeof(StreetRoom):
                return new StreetRoom(roomDTO.Id, data.Name, new MapIndex(roomDTO.MapOffsetY, roomDTO.MapOffsetX),
                    roomDTO.Floor, roomDTO.Color, roomDTO.Rotation, roomDTO.State,
